...
const softSkills = [
  { name: 'Communication', percentage: 90, icon: 'fas fa-comments' },
  { name: 'Problem Solving', percentage: 85, icon: 'fas fa-puzzle-piece' },
  { name: 'Teamwork', percentage: 95, icon: 'fas fa-users' },
  { name: 'Creativity', percentage: 80, icon: 'fas fa-lightbulb' },
  { name: 'Project Management', percentage: 75, icon: 'fas fa-tasks' },
];
