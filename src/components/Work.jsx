  ...
  const projects = [
    {
      ...
      liveDemo: "https://food-delivery-max.netlify.app/",
      sourceCode: "https://github.com/habtamugetachew/food-delivery-app.git"
    },
    {
      id: 2,
      title: "HG Tech Shop",
    ...
    {
      id: 4,
      title: "Hospital System Pro",
      icon: "fas fa-hospital",
      image: "",
      shortDescription: "A healthcare management portal with secure login and administrative workflows.",
      description: "A professional hospital management interface featuring a secure login page, patient administration dashboards, appointment scheduling, and staff management workflows.",
      features: [
      ...
      technologies: ["React", "CSS3", "Responsive Design", "Authentication UI"],
      liveDemo: "https://hospital-system-pro.netlify.app/login",
      sourceCode: "https://github.com/habtamugetachew/Hospital-System.git"
    }
  ];
